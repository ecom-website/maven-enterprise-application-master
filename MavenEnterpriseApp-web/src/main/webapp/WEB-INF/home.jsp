...
<html>
<head>
<spring:url value="/resources/images/vedhalogo.jpg" var="vedhalogo" />
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>VedhaTechnologies- Home Page</title>
<link href="${vedhalogo}" rel="icon">
</head>
</head>
<body>
<h1 align="center">Welcome to Vedha Technologies.</h1>
...
<div style="text-align: center;">
	<span>
		<img src="${vedhalogo}" alt="" width="100"/>
...
<p align=center><small>Copyrights 2018 by <a href="http://vedhatechnologies.com/">Vedha Technologies</a> </small></p>
